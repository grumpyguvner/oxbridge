...
class Cart {
	...
	public function __construct($registry) {
		...
		$this->weight = $registry->get('weight');
				...
				if (!isset($this->session->data['oe']['oe_product']) || !is_array($this->session->data['oe']['oe_product'])) {
					$this->session->data['oe']['oe_product'] = array();
				}
				if (!isset($this->session->data['oe']['custom_product']) || !is_array($this->session->data['oe']['custom_product'])) {
					$this->session->data['oe']['custom_product'] = array();
				}
	...
	public function getProducts() {
		if (!$this->data) {
			foreach ($this->session->data['cart'] as $key => $quantity) {
				...
				if (isset($this->session->data['oe']['oe_product'][$key]['price'])) {
					$price = $this->session->data['oe']['oe_product'][$key]['price'];
					$option_price = 0;
				}
				if (isset($this->session->data['oe']['oe_product'][$key]['notax'])) {
					$notax = 1;
				} else {
					$notax = 0;
				}
	...
	public function remove($key) {
		...
		unset($this->session->data['cart'][$key]);
				...
				unset($this->session->data['oe']['oe_product'][$key]);

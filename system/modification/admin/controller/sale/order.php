...
class ControllerSaleOrder extends Controller {
	...
	protected function getList() {
		...
		$data['shipping'] = $this->url->link('sale/order/shipping', 'token=' . $this->session->data['token'], 'SSL');
				...
				$data['clear_order_entry'] = $this->url->link('sale/order_entry/clearOrderEntry', 'token=' . $this->session->data['token'], 'SSL');
			
		$data['add'] = 
				$this->url->link('sale/order_entry/add', 'token=' . $this->session->data['token'], 'SSL');
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'edit'          => 
				$this->url->link('sale/order_entry/edit', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
		...
		$data['button_view'] = $this->language->get('button_view');
				...
				$data['button_clear_order_entry'] = $this->language->get('button_clear_order_entry');
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['edit'] = 
				$this->url->link('sale/order_entry/edit', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');

  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      <div class="pull-right">
				...
				<button type="submit" id="button-clear-order-entry" form="form-order" formaction="<?php echo $clear_order_entry; ?>" data-toggle="tooltip" title="<?php echo $button_clear_order_entry; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>

...
<td class="left"><b>Product Custom H1 Generator</b></td>
                ...
                <td class="right">
					...
					<a onclick="location = 'custom_h1_generator.php?token=<?php echo $token; ?>'" class="button">Generate</a>
					<?php } else { ?>
...
<p><a onclick="clearseo('Product Custom H2s', '<?php echo $clearh2s; ?>');" class="button" style="background:red">Clear Custom H2s</a></p>

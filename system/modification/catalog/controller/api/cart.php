		...
		if (!isset($this->session->data['api_id'])) {
			...
			if (isset($this->request->post['product_id'])) {
				...
				if (isset($this->request->post['custom_price'])) {
					$this->session->data['oe']['oe_product'][$key]['price'] = $this->request->post['price'];
				}
			...
			$json['error'] = $this->language->get('error_permission');
				...
				if ($product_info) {
					if ($product_info['price'] != $this->request->post['price']) {
						$this->session->data['oe']['oe_product'][$this->request->post['key']]['price'] = $this->request->post['price'];
					} else {
	...
	public function products() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			foreach ($products as $product) {
				...
				if ($product['notax']) {
					$price_t = $this->currency->format($product['price']);
					$total_t = $this->currency->format($product['price'] * $product['quantity']);;
				} else {
					$price_t = $this->currency->format($this->tax->calculate($product['price'], $product['tax_class_id'], $this->config->get('config_tax')));
					$total_t = $this->currency->format($this->tax->calculate($product['price'], $product['tax_class_id'], $this->config->get('config_tax')) * $product['quantity']);
				}
				...
				$json['products'][] = array(
					...
					'price'      
							=> $this->currency->format($product['price'], false, false, false),
				'price_t'	=> $price_t,
			
					'total'      
									=> $this->currency->format($product['price'] * $product['quantity'], false, false, false),
				'total_t'			=> $total_t,
				'notax'				=> $product['notax'],

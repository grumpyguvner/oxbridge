	...
	public function address() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ((utf8_strlen(trim($this->request->post['address_1'])) < 3) || (utf8_strlen(trim($this->request->post['address_1'])) > 128)) {
				...
				if ($this->config->get('oe_require_city') && ((utf8_strlen($this->request->post['city']) < 2) || (utf8_strlen($this->request->post['city']) > 32))) {
			...
			if ($this->request->post['country_id'] == '') {
				...
				if ($this->config->get('oe_require_zone') && (!isset($this->request->post['zone_id']) || $this->request->post['zone_id'] == '')) {

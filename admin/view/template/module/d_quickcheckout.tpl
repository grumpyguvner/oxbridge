                                    ...
                                    <div class="col-sm-10">
                                        <div class="tab-content">
                                            ...
                                            <div id="d_general" class="tab-pane">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-4 control-label" for="input-catalog-limit">
                                                                <span data-toggle="tooltip" title="<?php echo $help_general_update_mini_cart; ?>">
                                                                    <?php echo $entry_general_update_mini_cart; ?>
                                                                </span>
                                                            </label>
                                                            <div class="col-sm-8">
                                                                <input type="hidden" value="0" name="<?php echo $id; ?>_setting[general][update_mini_cart]" />
                                                                <input type="checkbox" value="1" name="<?php echo $id; ?>_setting[general][update_mini_cart]" <?php if(isset($setting['general']['update_mini_cart']) && $setting['general']['update_mini_cart'] == 1){ ?>checked="checked"<?php } ?> id="general_update_mini_cart" />
                                                            </div>
                                                        </div>
                                            ...
                                            <div id="d_login" class="tab-pane">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="login_option_guest_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="login_option_register_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="login_option_login_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="login_description_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                            ...
                                            <div id="d_payment_address" class="tab-pane">
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <?php foreach($setting['step']['payment_address']['fields'] as $field){ if(isset($field['title'])){ ?>
                                                            <tr id="payment_address_<?php echo $field['id']; ?>_input"
                                                                ...
                                                                <td>
                                                                    <?php if($setting['step']['payment_address']['fields'][$field['id']]['type'] == 'checkbox'){ ?>
                                                                    ...
                                                                    <?php } ?>
                                                                    <?php if($setting['step']['payment_address']['fields'][$field['id']]['type'] == 'select'){ ?>
                                                                    ...
                                                                    <?php if($setting['step']['payment_address']['fields'][$field['id']]['type'] == 'text'
                                                                        ...
                                                                        <?php } ?>
                                                                        <input class="form-control pull-right" data-toggle="tooltip" title="<?php echo $help_maskedinput; ?>" placeholder="mask" type="text" name="<?php echo $id; ?>_setting[step][payment_address][fields][<?php echo $field['id']; ?>][mask]" value="<?php echo (isset($setting['step']['payment_address']['fields'][$field['id']]['mask'])) ? $setting['step']['payment_address']['fields'][$field['id']]['mask'] : ''; ?>" />
                                                                    <?php } ?>
                                                                </td>
                                                                <?php foreach($options as $option) { ?>
                                                                <td >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="payment_address_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="payment_address_description_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                            ...
                                            <div id="d_shipping_address" class="tab-pane">
                                                            ...
                                                            <tr id="shipping_address_<?php echo $field['id']; ?>_input" class="sort-item <?php echo ($field['type'] == 'system')? 'hide' : ''; ?>" sort-data="<?php echo (isset($setting['step']['shipping_address']['fields'][$field['id']]['sort_order']) ? $setting['step']['shipping_address']['fields'][$field['id']]['sort_order'] : ''); ?>">
                                                                <td class="name">
                                                                    <label class="">
                                                                        ...
                                                                        <input class="sort" type="hidden" value="<?php echo (isset($setting['step']['shipping_address']['fields'][$field['id']]['sort_order'])) ? $setting['step']['shipping_address']['fields'][$field['id']]['sort_order'] : ''; ?>" name="<?php echo $id; ?>_setting[step][shipping_address][fields][<?php echo $field['id']; ?>][sort_order]" />
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                <?php if($setting['step']['shipping_address']['fields'][$field['id']]['type'] == 'checkbox'){ ?>
                                                                ...
                                                                <?php } ?>
                                                                <?php if($setting['step']['shipping_address']['fields'][$field['id']]['type'] == 'select'){ ?>
                                                                ...
                                                                <?php if($setting['step']['shipping_address']['fields'][$field['id']]['type'] == 'text'
                                                                    ...
                                                                    <?php }?>
                                                                        <input class="form-control pull-right" placeholder="mask" type="text" name="<?php echo $id; ?>_setting[step][shipping_address][fields][<?php echo $field['id']; ?>][mask]" value="<?php echo (isset($setting['step']['shipping_address']['fields'][$field['id']]['mask'])) ? $setting['step']['shipping_address']['fields'][$field['id']]['mask'] : ''; ?>" />
                                                                <?php } ?>
                                                                </td>
                                                                <?php foreach($options as $option) { ?>
                                                                <td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="shipping_address_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="shipping_address_description_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                            ...
                                            <div id="d_shipping_method" class="tab-pane">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="shipping_method_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="shipping_method_description_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                            ...
                                            <div id="d_payment_method" class="tab-pane">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="payment_method_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="payment_method_description_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    <?php $i = 0; foreach ($payment_methods as $payment_method) { ?>
                                                        ...
                                                        <?php } ?>
                                                        <label class="col-sm-3 control-label" >
                                                            <?php echo $payment_method['status'] == 1 ? '<i class="fa fa-toggle-on status-payment" title="This payment is enabled" aria-hidden="true"></i>' : ''; ?>
                                            ...
                                            <div id="d_confirm" class="tab-pane">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="cart_title_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <?php foreach ($languages as $language) { ?>
                                                        <div id="tab_general_min_order_text_<?php echo $language['language_id']; ?>" class="input-group">
                                                            <label class="input-group-addon" for="cart_description_<?php echo $language['language_id']; ?>" title="<?php echo $language['name']; ?>"><img src="<?php echo $language['flag']; ?>" title="<?php echo $language['name']; ?>" /></label>
                                                            ...
                                                            <tr id="confirm_<?php echo $field['id']; ?>_input" class="sort-item <?php echo ($field['type'] == 'system')? 'hide' : ''; ?>" sort-data="<?php echo (isset($setting['step']['confirm']['fields'][$field['id']]['sort_order']) ? $setting['step']['confirm']['fields'][$field['id']]['sort_order'] : ''); ?>">
                                                                <td class="name">
                                                                    <label class="">
                                                                        ...
                                                                        <input class="sort" type="hidden" value="<?php echo (isset($setting['step']['confirm']['fields'][$field['id']]['sort_order'])) ? $setting['step']['confirm']['fields'][$field['id']]['sort_order'] : ''; ?>" name="<?php echo $id; ?>_setting[step][confirm][fields][<?php echo $field['id']; ?>][sort_order]" />
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                <?php if($setting['step']['confirm']['fields'][$field['id']]['type'] == 'checkbox'){ ?>
                                            ...
                                            <div id="d_design" class="tab-pane">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="input-catalog-limit">
                                                        <span data-toggle="tooltip" title="<?php echo $help_design_autocomplete; ?>">
                                                            <?php echo $entry_design_autocomplete ?>
                                                        </span>
                                                    </label>
                                                    <div class="col-sm-9">
                                                        <input type="hidden" value="0" name="<?php echo $id; ?>_setting[design][autocomplete]" />
                                                        <input type="checkbox" value="1" data-label-text="<?php echo $text_enable; ?>" name="<?php echo $id; ?>_setting[design][autocomplete]" <?php echo (isset($setting['design']['autocomplete']) && $setting['design']['autocomplete'])? 'checked="checked"' : ''; ?> id="design_autocomplete" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="input-catalog-limit">
                                                        <span data-toggle="tooltip" title="<?php echo $help_design_only_d_quickcheckout; ?>">
                                                            <?php echo $entry_design_only_d_quickcheckout; ?>
                                                        </span>
                                                    </label>
                                                    <div class="col-sm-9">
                                            ...
                                            <div id="d_analytics" class="tab-pane">
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php foreach($analytics_getAll as $stat){ ?>
                                                        <tr>

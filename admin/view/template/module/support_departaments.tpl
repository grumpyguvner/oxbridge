          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($departament['departament_group_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $departament['departament_group_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $departament['departament_group_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $departament['name']; ?></td>
                  <td class="text-right"><?php echo $departament['sort_order']; ?></td>
                  <td class="text-right"><a href="<?php echo $departament['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>

                  ...
                  <tr>
                      <td colspan="2">
                            <div class="form-group">
                                ...
                                <input type="text" class="licenseCodeBox form-control" placeholder="&nbsp;License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" name="Nitro[LicenseCode]" id="moduleLicense" value="<?php echo !empty($data['Nitro']['LicenseCode']) ? $data['Nitro']['LicenseCode'] : ''?>" />
                            </div>

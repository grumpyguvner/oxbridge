...
<div class="container">
	...
	if ($column_left && $column_right) {
		...
		$content_left  = 'col-sm-4 col-lg-8';
		$content_right = 'col-sm-8 col-lg-4';
	} ?>
                ...
                <div class="<?php echo $content_left; ?> product_page-left">
                                ...
                                <li>
                                    <a href="#" data-image="<?php echo $image['popup']; ?>"
                                       data-zoom-image="<?php echo $image['popup']; ?>"><img
                                            src="<?php echo $image['thumb']; ?>" alt=""/></a>
                                </li>
                                <?php } ?>
                    ...
                    <div id="full_gallery">
                        <ul id="gallery">
                            ...
                            <?php foreach ($images as $image) { ?>
                            <li>
                                <a href="<?php echo $image['popup']; ?>" data-something="something<?php echo $i?>"
                                   data-another-thing="anotherthing<?php echo $i?>"><img
                                        src="<?php echo $image['popup']; ?>" alt="<?php echo $heading_title; ?>"/></a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>

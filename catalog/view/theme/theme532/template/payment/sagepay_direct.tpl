  ...
  <fieldset id="payment">
    ...
    <div id="card-new">
      ...
      <div class="form-group required">
        ...
        <div class="col-sm-10">
          <select name="cc_type" id="input-cc-type" class="form-control" style="width: 100%">
      ...
      <div class="form-group required">
        ...
        <div class="col-sm-2">
          <select name="cc_start_date_month" id="input-cc-start-date" class="form-control" style="width:100%">
        ...
        <div class="col-sm-3">
          <select name="cc_start_date_year" class="form-control" style="width:100%">
            <?php foreach ($year_valid as $year) { ?>
            <option value="<?php echo $year['value']; ?>"><?php echo $year['text']; ?></option>
            <?php } ?>
          </select>
        </div>
        <div class="visible-lg-block" style="position: absolute; right: 50px;"><img src="https://oxbridgehomelearning.uk/image/catalog/main-logos/thawte-logo.png"></div>
      </div>
      <div class="form-group required">
        <label class="col-sm-2 control-label" for="input-cc-expire-date"><?php echo $entry_cc_expire_date; ?></label>
        <div class="col-sm-2">
          <select name="cc_expire_date_month" id="input-cc-expire-date" class="form-control" style="width:100%">
            <?php foreach ($months as $month) { ?>
            <option value="<?php echo $month['value']; ?>"><?php echo $month['value']; ?></option>
            <?php } ?>
          </select>
        ...
        <div class="col-sm-3">
          <select name="cc_expire_date_year" class="form-control" style="width:100%">

...
span.content{display:block; font-size:12px; padding:10px 15px;}
span.footer p{margin-bottom:0;}
span.footer{display:block; font-size:12px; padding:10px 15px; border-radius: 0 0 6px 6px;
...
.contain{width:<?php echo $width.$width_unit; ?>;margin:0 auto;text-align:inherit;}
span.top{color:<?php echo $color['text_top']; ?>; background-color:<?php echo $color['bg_top']; ?>; <?php echo $theme['bg_top'] ? 'background-image:url('.$img_path.$theme['bg_top'].') '.$theme['bg_top_repeat'].';' : ''; ?>;}
span.top a{color:<?php echo $color['link_top']; ?>;}
span.bottom{color:<?php echo $color['text_bottom']; ?>; background-color:<?php echo $color['bg_bottom']; ?>; <?php echo $theme['bg_bottom'] ? 'background-image:url('.$img_path.$theme['bg_bottom'].') '.$theme['bg_bottom_repeat'].';' : ''; ?>;}
span.bottom a{color:<?php echo $color['link_bottom']; ?>;}
</style>
</head>
<body>
    ...
    <td class="page center" align="center" valign="top">
      <center>
        ...
        <table class="container">
          <tr><td><span class="top"><?php echo $top; ?></span></td></tr>
        </table>
        <?php } ?>
        ...
        <tr>
          <td class="header center" <?php echo $theme['bg_header'] ? 'background="'.$img_path.$theme['bg_header'].'"' : ''; ?>>
            <center><span><a href="<?php echo $store_url; ?>"><img class="center" src="<?php echo $img_path.$theme['logo']; ?>" alt="<?php echo $store_name; ?>" /></a></span></center>
          </td>
        </tr>
        <tr>
          <td><span class="content"><?php echo $main_content; ?></span></td>
        </tr>
        <?php if (!empty($footer)) { ?>
        <tr>
          <td><span class="footer"><?php echo $footer; ?></span></td>
        </tr>
        <?php } ?>
        </table>
        ...
        <table class="container">
          <tr><td><span class="bottom"><?php echo $bottom; ?></span></td></tr>
        </table>
        <?php } ?>
